    ...
    $.fn.mapit = function (options) {
        var defaults = {
            ...
            marker: {
                ...
                latitude: -7.228830,
                longitude: -35.882303,
                icon: "imagens/markers/marker_red.png",
                title: "SPDI",
                open: false,
                center: true
            },
            address: "<h2>SPDI</h2><p>endereço</p>",
            styles: "GRAYSCALE",
            locations: [[37.999252, 23.733353, "images/marker_blue.png", "Cinema Aello 5+1", "Panagi Tsaldari 140, Athina, Greece", false, "1"], [37.996547, 23.732001, "images/marker_blue.png", "Cinema Ilion", "Τροίας 34, Αθήνα, Greece", false, "1"], [37.959408, 23.713982, "images/marker_blue.png", "Cinema Calipso", "Megalou Alexandrou ke Kalipsous, Kallithea, Greece", false, "1"], [37.977563, 23.714041, "images/marker_green.png", "Technopolis", "Πειραιώς 100, Αθήνα, Greece", false, "2"], [37.971436, 23.736695, "images/marker_green.png", "Zappeion", "Greece", false, "2"], [37.97503, 23.747751, "images/marker_green.png", "Εθνική Πινακοθήκη Μουσείο Αλεξάνδρου Σούτζου", "Μιχαλακοπούλου 1, Αθήνα, Greece", false, "2"], [37.976104, 23.7141811, "images/marker_green.png", "Benaki Museum", "Koumpari 1, Athens, Greece", false, "2"]],
            origins: [["37.936294", "23.947394"], ["37.975669", "23.733868"]]
        };
        ...
        $(this).each(function () {
            ...
            if (options.styles) {
                ...
                var MIDNIGHT_style = [{featureType: "water", stylers: [{color: "#021019"}]}, {
            ...
            var info = new google.maps.InfoWindow({content: options.address});
